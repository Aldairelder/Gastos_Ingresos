      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-md-12 mb-3">
            ...
            <input type="text" name="entidad" class="form-control" placeholder="Nombre de la Persona" value="{{ $rs->entidad }}" readonly>
          </div>
          <div class="col-md-12 mb-3">
            <label class="form-label">Dirección</label>
            <input type="text" name="direccion" class="form-control" placeholder="Dirección de la Persona" value="{{ $rs->direccion }}" readonly>
          </div>
          <div class="col-md-12 mb-3">
            <label class="form-label">Telefono</label>
            <input type="text" name="telefono" class="form-control" placeholder="Telefono de la Persona" value="{{ $rs->telefono }}" readonly>
          </div>
          <div class="col-md-12 mb-3">

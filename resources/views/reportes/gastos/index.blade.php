              ...
              <tr data-fecha="{{ $rs->created_at->toDateString() }}">
                ...
                <td class="align-middle no-print">
                  <div class="btn-group" role="group" aria-label="Basic example">
                    <a href="{{ route('gastos.show', $rs->id) }}" type="button" class="btn btn-info" style="font-size: 12px; padding: 4px 10px;"><i class="fas fa-eye">VER</i></a>
                  </div>
                </td>
              </tr>
...
<script>
   $(document).ready(function() {
    ...
    $('#exportarExcel').on('click', function() {
      ...
      var ws = XLSX.utils.aoa_to_sheet([['.:. Listado - Gastos .:.']]);
      ...
      XLSX.utils.sheet_add_aoa(wb.Sheets['Gastos'], tableData, { origin: 'A2' });
